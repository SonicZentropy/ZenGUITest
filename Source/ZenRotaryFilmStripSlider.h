...
//class ZenRotaryFilmStripSlider 
//	: public Slider//,
//public AsyncUpdater,
...
To use it, create a ZenRotaryFilmStripSlider object and use the setSliderStyle() method
...
// 	};
	...
	*/
	enum TextEntryBoxPosition
	{
		...
		TextBoxCentered /**< Puts the text box on the slider itself, centered */
	};
	...
	*/
	...
	ZenRotaryFilmStripSlider(const String& imgName, const int numFrames, const int knobWidth=64, const int knobHeight=64, const bool stripIsHorizontal=false);
	/** Creates a slider.
	When created, you can set up the slider's style and range with setSliderStyle(), setRange(), etc.
	*/
	//explicit ZenRotaryFilmStripSlider(const String& componentName);

	/** Creates a slider with some explicit options. */
	//ZenRotaryFilmStripSlider(SliderStyle style, TextEntryBoxPosition textBoxPosition);
	...
	*/
	...
	void removeListener(Slider::Listener* listener);
...
// 	};
	...
	relative to the bounds of the whole ZenRotaryFilmStripSlider component.
	*/
// 	struct SliderLayout
// 	{
...
// 	};
	...
	*/
	...
	const Rectangle<int>& getSliderRect() const;
